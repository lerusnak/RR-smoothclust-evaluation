...
*3 Nonspatial clusters*
```{r}
length(km.clus3.uni)
length(km.clus3.nonspac)

# check cluster frequencies
table(km.clus3.uni)
table(km.clus3.nonspac)
```


```{r}
# get cluster labels
smoothclust_labels <- sort(unique(km.clus3.uni))
kmeans_labels <- sort(unique(km.clus3.nonspac))
...
smoothclust_clus <- as.factor(km.clus3.uni)
kmeans_clus <- as.factor(km.clus3.nonspac)
...
*4 Nonspatial clusters*
```{r}
length(km.clus3.uni)
length(km.clus4.nonspac)

# check cluster frequencies
table(km.clus3.uni)
table(km.clus4.nonspac)
```
...
# get cluster labels
smoothclust_labels <- sort(unique(km.clus3.uni))
kmeans_labels <- sort(unique(km.clus4.nonspac))
...
# convert vectors of cluster labels to factors so empty levels are not dropped when subsetting
smoothclust_clus <- as.factor(km.clus3.uni)
kmeans_clus <- as.factor(km.clus4.nonspac)
...
*6 Nonspatial clusters*
```{r}
length(km.clus3.uni)
length(km.clus6.nonspac)

# check cluster frequencies
table(km.clus3.uni)
table(km.clus6.nonspac)
```
...
# get cluster labels
smoothclust_labels <- sort(unique(km.clus3.uni))
kmeans_labels <- sort(unique(km.clus6.nonspac))
...
# convert vectors of cluster labels to factors so empty levels are not dropped when subsetting
smoothclust_clus <- as.factor(km.clus3.uni)
kmeans_clus <- as.factor(km.clus6.nonspac)
...
#### Kernel, 0.02 3 Clusters

*3 Nonspatial clusters*
```{r}
length(km.clus3.kern02)
length(km.clus3.nonspac)

# check cluster frequencies
table(km.clus3.kern02)
table(km.clus3.nonspac)
```
...
```{r}
# get cluster labels
smoothclust_labels <- sort(unique(km.clus3.kern02))
kmeans_labels <- sort(unique(km.clus3.nonspac))
...
# convert vectors of cluster labels to factors so empty levels are not dropped when subsetting
smoothclust_clus <- as.factor(km.clus3.kern02)
kmeans_clus <- as.factor(km.clus3.nonspac)
...
```{r}
# get cluster labels
smoothclust_labels <- sort(unique(km.clus4.uni))
kmeans_labels <- sort(unique(km.clus3.nonspac))
...
# convert vectors of cluster labels to factors so empty levels are not dropped when subsetting
smoothclust_clus <- as.factor(km.clus4.uni)
kmeans_clus <- as.factor(km.clus3.nonspac)
